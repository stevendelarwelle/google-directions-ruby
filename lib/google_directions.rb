...
class GoogleDirections
  ...
  def drive_time_in_minutes
    if @status != "OK"
      ...
      drive_time = @doc.css("route leg duration value").last.text
  ...
  def distance
    ...
    unless @status == 'OK'
      ...
      @distance = @doc.css("route leg distance value").last.text
    end
  end
  ...
  def distance_text
    ...
    unless @status == 'OK'
      ...
      @distance_text = @doc.css("route leg distance text").last.text
    end
  end
